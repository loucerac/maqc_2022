...
\begin{frame}{COVID19}
	\begin{columns}
		...
		\begin{column}{0.4\textwidth}
			\centering
			\includegraphics[width=0.8\textwidth]{fig/covipathia.png}
		...
		\begin{column}{0.6\textwidth}
			\centering
			\includegraphics[width=0.8\textwidth]{fig/loucera_covid_rep.jpg}
			\captionof{figure}{Reposicionamiento de fármacos\footnotemark}
		\end{column}
	\end{columns}
	\footnotetext[1]{\fullcite{rian2021mechanistic}}
\end{frame}


\begin{frame}{xML Drug repurposing}
	\begin{columns}
